...
uploaded_file = st.sidebar.file_uploader(
    "Upload UAE real estate CSV (optional)", type=["csv"]
)
...
if uploaded_file is not None:
    ...
    df = pd.read_csv("uae_real_estate_2024.csv")  # bundled sample in your repo
    st.sidebar.info("Using built‑in 2024 UAE sample dataset")
