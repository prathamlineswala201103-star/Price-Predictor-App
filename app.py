...
st.markdown("""
<h1 style='text-align: center; color: #145DA0;'>🏠 Dubai Real Estate Price Predictor</h1>
...
with mid:
    ...
    if st.button("🎬 Predict Price!"):
        ...
        <div style='padding: 16px; background: #F0F5F9; border-radius: 12px; text-align: center; margin-top: 20px;'>
            <h2 style='color: #145DA0;'>💰 Estimated Price: AED {prediction:,.2f}</h2>
        </div>
        """, unsafe_allow_html=True)

# Dataset price distribution plot in expander
with st.expander("📊 Price Distribution (Sample)"):
